...
すべて「$\varphi$ が真でなければ $c \ge 0$ のペナルティを受ける」で記述しているが、
「$\varphi$ が真でなければ $d \ge 0$ の報酬 ($-d \gt 0$ のペナルティ) を受ける」あるいは同じことだが「$\lnot \varphi$ が真ならば $d \ge 0$ の報酬 ($-d \gt 0$ のペナルティ) を受ける」という形の制約も扱うことができる。
これは「無条件で $d \ge 0$ の報酬を受けとる」および「$\lnot \varphi$ が真でなければ $d \ge 0$ のペナルティを受ける」というふたつの制約を用いることで表現できる。
