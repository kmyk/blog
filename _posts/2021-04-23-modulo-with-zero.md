...
$5! = 40 \cdot 3^1$ かつ $3! = 1 \cdot 3^1$ かつ $2! = 2 \cdot 3^0$ でありまた $40 \equiv 1 \pmod{3}$ かつ $2^{-1} \equiv 2 \pmod{3}$ であるので $\frac{5!}{3! \cdot (5 - 3)!} = \frac{(1, 1)}{(1, 1) \cdot (2, 0)} = (1, 1) \cdot (1, -1) \cdot (2, 0) = (2, 0) = 2$ と計算ができます。
