...
\begin{tikzpicture}[
    ...
    \node[draw, circle, fill=white, minimum size=1.4cm] (c21) at (2.5, 1.5) {$(2, 1)$};
    \node[draw, circle, fill=white, minimum size=1.4cm] (c41) at (4.5, 1.5) {$(4, 1)$};
    \node[draw, circle, fill=white, minimum size=1.4cm] (c32) at (3.5, 2.5) {$(3, 2)$};
    \node[draw, circle, fill=white, minimum size=1.4cm] (c13) at (1.5, 3.5) {$(1, 3)$};
\end{tikzpicture}
\end{document}
